    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-950 py-12 md:py-16">
            <div className="container mx-auto px-4 md:px-6 max-w-4xl">
                <h1 className="text-4xl pt-4 font-bold text-slate-900 dark:text-white mb-8">
                    Terms of Service
                </h1>
                ...
                <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-slate-300">
                    ...
                    <section>
                        ...
                        <p>
                            Vaiu provides a collaborative platform for project management, including features such as workspace creation, team collaboration, analytics, and integration with third-party services like GitHub. The Service is offered on a subscription basis, with various plans available as detailed on our pricing page.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            To use the Service, you must be at least 18 years old and capable of entering into a binding contract. You agree to provide accurate, current, and complete information during the registration process and to update such information to keep it accurate, current, and complete.
                        </p>
                        <p>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside space-y-2 ml-4">
                            ...
                            <li>Use the Service to distribute malware or engage in fraudulent activities</li>
                    ...
                    <section>
                        ...
                        <p>
                            Certain features of the Service require payment of fees as specified on our pricing page. All fees are non-refundable unless otherwise stated. We may change our pricing at any time, but such changes will not affect existing subscriptions until renewal.
                        </p>
                        <p>
                            You agree to pay all charges associated with your account. Failure to pay may result in suspension or termination of your access to the Service.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            Your privacy is important to us. Our collection and use of personal information is governed by our Privacy Policy, which is incorporated into these Terms by reference. By using the Service, you consent to the collection and use of your information as outlined in the Privacy Policy.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            You agree to indemnify and hold harmless Vaiu, its directors, employees, and agents from any claims, damages, losses, or expenses arising from your use of the Service, violation of these Terms, or infringement of any rights of another party.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            These Terms shall be governed by and construed in accordance with the laws of [Jurisdiction, e.g., the State of California], without regard to its conflict of law provisions. Any disputes arising from these Terms shall be resolved through binding arbitration in [Location], and you waive any right to participate in class action lawsuits.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            These Terms constitute the entire agreement between you and us regarding the Service. If any provision of these Terms is found to be unenforceable, the remaining provisions will remain in full force and effect.
                        </p>
                        <p>
                            We may assign these Terms to any affiliate or successor without your consent. You may not assign these Terms without our prior written consent.
                        </p>
                    </section>
